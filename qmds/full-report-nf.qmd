...
<hr>
  ...
  This R Markdown aims to provide a brief summary of all diagnostic plots for your TREx experiment.<br> All large data files are available for download upon request.
